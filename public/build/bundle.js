...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	let main;
    	let loginwithextension;
    	let t;
    	let noextensionoptions;
    	let current;
    	loginwithextension = new /*LoginWithExtension*/ ctx[0]({ $$inline: true });
    	noextensionoptions = new /*NoExtensionOptions*/ ctx[1]({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(loginwithextension.$$.fragment);
    			t = space();
    			create_component(noextensionoptions.$$.fragment);
    			add_location(main, file$2, 5, 0, 90);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(loginwithextension, main, null);
    			append_dev(main, t);
    			mount_component(noextensionoptions, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(loginwithextension.$$.fragment, local);
    			transition_in(noextensionoptions.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(loginwithextension.$$.fragment, local);
    			transition_out(noextensionoptions.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(loginwithextension);
    			destroy_component(noextensionoptions);
    		}
    	};
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { LoginWithExtension } = $$props;
    	let { NoExtensionOptions } = $$props;

    	$$self.$$.on_mount.push(function () {
    		if (LoginWithExtension === undefined && !('LoginWithExtension' in $$props || $$self.$$.bound[$$self.$$.props['LoginWithExtension']])) {
    			console.warn("<App> was created without expected prop 'LoginWithExtension'");
    		}

    		if (NoExtensionOptions === undefined && !('NoExtensionOptions' in $$props || $$self.$$.bound[$$self.$$.props['NoExtensionOptions']])) {
    			console.warn("<App> was created without expected prop 'NoExtensionOptions'");
    		}
    	});

    	const writable_props = ['LoginWithExtension', 'NoExtensionOptions'];
    	...
    	$$self.$$set = $$props => {
    		if ('LoginWithExtension' in $$props) $$invalidate(0, LoginWithExtension = $$props.LoginWithExtension);
    		if ('NoExtensionOptions' in $$props) $$invalidate(1, NoExtensionOptions = $$props.NoExtensionOptions);
    	};

    	$$self.$capture_state = () => ({ LoginWithExtension, NoExtensionOptions });
    	...
    	return [LoginWithExtension, NoExtensionOptions];
    }
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, {
    			LoginWithExtension: 0,
    			NoExtensionOptions: 1
    		});
    	...
    	set LoginWithExtension(value) {
    		throw new Error("<App>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get NoExtensionOptions() {
    		throw new Error("<App>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set NoExtensionOptions(value) {
    		throw new Error("<App>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
...
zoo`.split('\n');
    ...
    */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 38, 4, 1259);
    			attr_dev(div, "class", "wrapper");
    			add_location(div, file$1, 37, 0, 1233);
    		},
    		l: function claim(nodes) {
    ...
    /* src\Extension.svelte generated by Svelte v3.59.2 */

    const file = "src\\Extension.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file, 2, 8, 62);
    			add_location(p1, file, 3, 8, 107);
    			attr_dev(a0, "href", "https://chromewebstore.google.com/detail/ampjiinddmggbhpebhaegmjkbbeofoaj");
    			add_location(a0, file, 5, 25, 193);
    			add_location(li0, file, 5, 12, 180);
    			...
    			add_location(a1, file, 6, 26, 326);
    			add_location(li1, file, 6, 12, 312);
    			attr_dev(a2, "href", "https://apps.apple.com/us/app/nostore/id1666553677");
    			add_location(a2, file, 7, 31, 521);
    			add_location(li2, file, 7, 12, 502);
    			add_location(ul, file, 4, 8, 163);
    			attr_dev(div0, "class", "register-link");
    			add_location(div0, file, 1, 4, 26);
    ...
    function instance($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Extension', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Extension> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class Extension extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const app = new App({
        ...
        props: {
            LoginWithExtension: Login,
            NoExtensionOptions: Extension
        }
    });
