...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file$2, 36, 16, 866);
			add_location(div0, file$2, 35, 12, 844);
			attr_dev(input, "type", "text");
			attr_dev(input, "placeholder", "Enter an activity..");
			attr_dev(input, "id", "item");
			add_location(input, file$2, 39, 16, 987);
			add_location(div1, file$2, 38, 12, 965);
			...
			add_location(path, file$2, 45, 28, 1418);
			add_location(g, file$2, 44, 24, 1386);
			...
			add_location(svg, file$2, 43, 20, 1166);
			attr_dev(button, "id", "add");
			attr_dev(button, "class", "add-todo-button");
			add_location(button, file$2, 42, 16, 1104);
			add_location(div2, file$2, 41, 12, 1082);
			attr_dev(div3, "class", "header");
			add_location(div3, file$2, 34, 8, 811);
			add_location(header, file$2, 33, 4, 794);
			attr_dev(ul0, "class", "todo");
			attr_dev(ul0, "id", "todo");
			add_location(ul0, file$2, 55, 8, 1782);
			attr_dev(ul1, "class", "todo");
			attr_dev(ul1, "id", "completed");
			add_location(ul1, file$2, 57, 8, 1856);
			attr_dev(div4, "class", "container");
			add_location(div4, file$2, 53, 4, 1715);
			attr_dev(script, "type", "module");
			if (!src_url_equal(script.src, script_src_value = "/js/main.js")) attr_dev(script, "src", script_src_value);
			add_location(script, file$2, 61, 4, 1935);
			add_location(body, file$2, 32, 0, 783);
			add_location(html, file$2, 21, 0, 331);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = space();
			p0 = element("p");
			p0.textContent = "Welcome to Zaplan! Your Ultimate nostr based To-Do List App!";
			t2 = space();
			p1 = element("p");
			p1.textContent = "Stay organized and boost your productivity with Zaplan.";
			t4 = space();
			button = element("button");
			...
			div0 = element("div");
			p2 = element("p");
			p2.textContent = "Don't have a nostr extension?";
			t8 = space();
			p3 = element("p");
			p3.textContent = "Check out these nostr extension options:";
			t10 = space();
			ul = element("ul");
			li0 = element("li");
			t11 = text("Chrome: ");
			...
			if (!src_url_equal(img.src, img_src_value = "./css/zaplan_logo.png")) attr_dev(img, "src", img_src_value);
			add_location(img, file, 46, 2, 1116);
			attr_dev(p0, "class", "title");
			add_location(p0, file, 48, 2, 1166);
			attr_dev(p1, "class", "description");
			add_location(p1, file, 51, 2, 1258);
			attr_dev(button, "class", "btn");
			add_location(button, file, 54, 4, 1354);
			add_location(p2, file, 56, 8, 1472);
			add_location(p3, file, 57, 8, 1517);
			attr_dev(a0, "href", "https://chromewebstore.google.com/detail/ampjiinddmggbhpebhaegmjkbbeofoaj");
			add_location(a0, file, 60, 24, 1619);
			add_location(li0, file, 59, 12, 1590);
			...
			add_location(a1, file, 63, 25, 1781);
			add_location(li1, file, 62, 12, 1751);
			attr_dev(a2, "href", "https://apps.apple.com/us/app/nostore/id1666553677");
			add_location(a2, file, 66, 30, 2005);
			add_location(li2, file, 65, 12, 1970);
			add_location(ul, file, 58, 8, 1573);
			attr_dev(div0, "class", "register-link");
			add_location(div0, file, 55, 4, 1436);
			attr_dev(div1, "class", "wrapper");
			add_location(div1, file, 45, 0, 1092);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
