...
document.querySelector('.js-nostr-receive-button')
  .addEventListener('click', () => {
    console.log("Clicked!");

    var relay = "wss://nostr.mom";
    var socket = new WebSocket( relay );
    ...
    socket.addEventListener('event', async function( message ) {
      console.log(message);
      ...
      relayData = JSON.parse(content);
      console.log(relayData);
    });

  });

document.querySelector('.js-nostr-check-button')
.addEventListener('click', () => {
  console.log(localData);
});

document.querySelector('.js-nostr-send-button')
.addEventListener('click', () => {
  console.log("Clicked!");
  var messageToBeSent = [ "EVENT", subId,  signedEvent];
